...
class DICM_Lh_Header extends ET_Builder_Module {
	...
	function render( $attrs, $content = null, $render_slug ) {
		...
		$layout = $this->props['layout'] === 'on' ? 'hero' : 'regular';
		$title = $this->props['title'];
		$subtitle = $this->props['subtitle'];
		$background = $this->props['background'];
		$hero_background = $layout === 'hero' ? 'style="background-image: url(' . $background . ')"' : '';

		// Render module content
		ob_start();
		?>

		<header class="new-page-header new-page-header--<?php echo $layout; ?>" <?php echo $hero_background; ?>>

			<?php if($layout === 'regular') {?>
