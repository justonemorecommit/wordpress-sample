 ...
 * @since 1.0.0
 */
class Lh_Header_Hero extends ET_Builder_Module {
	// Module slug (also used as shortcode tag)
	public $slug       = 'Lh_Header_Hero_block';
	...
	function init() {
		// Module name
		$this->name             = esc_html__( 'Laserhub Header Hero', 'dicm-divi-custom-modules' );
	...
	function render( $attrs, $content = null, $render_slug ) {
		...
		$hero_background = 'style="background-image: url(' . $background . ')"';

		// Render module content
		ob_start();
		?>

		<header class="new-page-header new-page-header--hero" <?php echo $hero_background; ?>>
